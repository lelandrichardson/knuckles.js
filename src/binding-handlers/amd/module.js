...
bindingHandlers.module = {
    init: function(element, valueAccessor, allBindingsAccessor, data, context) {
        var value = valueAccessor(),
            options = unwrap(value),
            templateBinding = {},
            initializer = bindingHandlers.module.initializer || "initialize";
        ...
        if (options && typeof options === "object") {
            ...
            each(["afterRender", "templateEngine"], function(option) {
                if (options[option]) {
        ...
        templateBinding.data = observable();
        templateBinding["if"] = templateBinding.data;

        //actually apply the template binding that we built
        applyBindingsToNode(element, { template: templateBinding },  context);
        ...
        computed({
            read: function() {
                ...
                if (moduleName) {
                    require([addTrailingSlash(bindingHandlers.module.baseDir) + moduleName], function(mod) {
